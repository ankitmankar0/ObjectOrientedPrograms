...
namespace StockReport
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string file = @"C:\Users\ankit\Desktop\bridgelab\.Net\Inventory Management\Commercial data processing\Commercial data processing\json.json";
            string acc = @"C:\Users\ankit\Desktop\bridgelab\.Net\Inventory Management\Commercial data processing\Commercial data processing\Account.json";
